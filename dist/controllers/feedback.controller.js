...
const submitFeedback = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield feedbackService.submitFeedback(userId, emoji, targetId, targetType);
...
const getFeedback = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const feedbacks = yield feedbackService.getFeedbackForTarget(targetId, targetType, emoji, userId);
