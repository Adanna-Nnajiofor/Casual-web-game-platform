...
const questions = [
    ...
    // SPORTS
    {
        question: "Who is known as the 'Mathematical' in Nigerian football history?",
        options: [
            "Rashidi Yekini",
            "Jay-Jay Okocha",
            "Segun Odegbami",
    ...
    {
        question: "Which Nigerian footballer scored Nigeria's first-ever World Cup goal?",
        options: [
            "Daniel Amokachi",
            "Rashidi Yekini",
            "Jay-Jay Okocha",
    ...
    {
        question: "In which year did Nigeria's Super Eagles win their first AFCON title?",
        options: ["1980", "1994", "2000", "2013"],
        answer: "1980",
        category: "Sports",
    },
    {
        question: "Which Nigerian female athlete is known as the 'Queen of the Track'?",
        options: [
            "Blessing Okagbare",
            "Mary Onyali",
            "Falilat Ogunkoya",
    ...
    {
        question: "Who was the captain of the Super Eagles during the 2013 AFCON win?",
        options: ["Kanu Nwankwo", "Joseph Yobo", "Vincent Enyeama", "Mikel Obi"],
        answer: "Joseph Yobo",
        category: "Sports",
    },
    {
        question: "Which Nigerian striker is known for the famous goal celebration 'Flute Dance'?",
        options: [
            "Jay-Jay Okocha",
            "Kanu Nwankwo",
            "Rashidi Yekini",
    ...
    {
        question: "Nigeria's famous 'D’Tigress' is the national team for which sport?",
    ...
    {
        question: "In which year did Nigeria’s Golden Eaglets win their first U-17 World Cup?",
        options: ["1985", "1993", "2007", "2013"],
        answer: "1985",
        category: "Sports",
    },
    {
        question: "Which Nigerian athlete broke the 100m hurdles world record in 2022?",
        options: [
            "Mary Onyali",
            "Falilat Ogunkoya",
            "Blessing Okagbare",
    ...
    {
        question: "Which Nigerian female footballer won the CAF Women’s Player of the Year award four times?",
        options: [
            "Asisat Oshoala",
            "Perpetua Nkwocha",
            "Mercy Akide",
    ...
    {
        question: "Who is the first Nigerian boxer to become a heavyweight world champion?",
    ...
    {
        question: "Which Nigerian player scored a hat-trick against Cameroon in AFCON 2004?",
        options: [
            "Jay-Jay Okocha",
            "Julius Aghahowa",
            "Obafemi Martins",
    ...
    {
        question: "Which Nigerian player won the FIFA U-17 World Cup Golden Boot in 2015?",
        options: [
            "Kelechi Iheanacho",
            "Victor Osimhen",
            "Samuel Chukwueze",
    ...
    {
        question: "Which Nigerian athlete won the Commonwealth gold medal in wrestling in 2018?",
        options: [
            "Odunayo Adekuoroye",
            "Blessing Oborududu",
            "Aminat Adeniyi",
    ...
    {
        question: "Who scored Nigeria’s winning goal against Argentina at the 1996 Olympics?",
        options: [
            "Kanu Nwankwo",
            "Jay-Jay Okocha",
            "Emmanuel Amuneke",
    ...
    {
        question: "Which Nigerian player won an NBA championship with the Milwaukee Bucks?",
        options: [
            "Hakeem Olajuwon",
    ...
    {
        question: "Which Nigerian athlete won bronze in the long jump at the 1996 Olympics?",
        options: [
            "Mary Onyali",
            "Falilat Ogunkoya",
            "Chioma Ajunwa",
    ...
    {
        question: "Which Nigerian athlete won silver at the 2000 Olympics in the 4x400m relay?",
        options: [
            "Mary Onyali",
            "Falilat Ogunkoya",
            "Fatimah Yusuf",
